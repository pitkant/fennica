...
harmonize_publisher_fennica <- function(df.orig, cheat_list, languages=c("english")) {
  ...
  publisher$name[-inds] <- clean_publisher_fennica(df.orig$publisher[-inds], languages=languages)
  ...
  known_names <- clean_publisher_fennica(df.orig$publisher[known_indices], languages=languages)
  unknown_names <- unique(clean_publisher_fennica(df.orig$publisher[unknown_indices], languages=languages))
  ...
  all_names <- clean_publisher_fennica(publisher$name, languages=c("finnish"))
