...
harmonize_publisher_fennica <- function(df.orig, cheat_list, languages=c("english")) {
  ...
  publisher$name[-inds] <- clean_publisher(harmonize_publishers_per_language(df.orig$publisher[-inds], languages))  
  ...
  known_names <- clean_publisher(harmonize_publishers_per_language(df.orig$publisher[known_indices], languages))  
  unknown_names <- unique(clean_publisher(harmonize_publishers_per_language(df.orig$publisher[unknown_indices], languages))  )
