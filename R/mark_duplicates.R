...
#' @param df Data frame of combined catalogs
...
mark_duplicates <- function (df,
  field_names = c("short_title", "publication_place", "publication_year")) {
  ...
  # NB!
  # Currently catches only those duplicates, that are found in
  # both Fennica and Kungliga
