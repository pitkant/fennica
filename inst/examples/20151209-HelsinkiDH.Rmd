...
p1 <- top_plot(dfo, "subject_topic", 10) + ylab("Title count (n)") + ggtitle(paste("Top themes (", min(na.omit(dfo$publication_year)), "-", max(na.omit(dfo$publication_year)), ")", sep = ""))
print(p1)

p2 <- top_plot(df, "subject_topic", 10) + ylab("Title count (n)") + ggtitle(paste("Top themes (", min(na.omit(df$publication_year)), "-", max(na.omit(df$publication_year)), ")", sep = ""))
print(p2)
```
