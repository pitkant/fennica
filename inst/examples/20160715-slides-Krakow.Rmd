...
## Global knowledge production and library catalogues
...
**Open source** fully transparent and reproducible data analytics; every single detail, from raw data to final visualization https://github.com/rOpenGov/fennica
...
### Practical exercise: Quantitative Study of Finnish Knowledge Production, 1640-1828
...
p <- ggplot(df2, aes(x = publication_decade, y = n)) +
     geom_line(aes(group = catalog), color = "black") +
     #geom_smooth(aes(fill = catalog)) + 
...
Pamphleteering plays a crucial role during abolished censorship in Sweden.
