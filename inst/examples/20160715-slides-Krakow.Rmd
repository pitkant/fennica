...
Mikko tsekkaa kuvien tekstit yms.

Gävle-kuva vaihdettu Tukholmaan, pitää tsiigata myös mitkä vuodet highlightataan.
...
```{r publishingactivitycomparisons, echo=FALSE, message=FALSE, cache=TRUE, fig.width=6, fig.height=5, fig.show="hold", out.width="160px"}
v <- seq(1500, 1800, 50)
...
TODO: Vaihdettiin tähän Stockholm, riittää julkaisumäärät. Miksi katalogina lukee Fennica?
