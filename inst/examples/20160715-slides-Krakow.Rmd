...
for (catal in "Kungliga") {
 ...
 cols = c("pink", "Purple", "aquamarine", "yellow")
...
npub$publisher <- factor(npub$publisher, levels = ord)
...
p <- ggplot(df, aes(x = publication_year, y = n, color = language)) +
       geom_line() + geom_point() + ylab("Documents (n)") + xlab("Publication year")
...
Form of literature denoting the advancement of reading in Finland in the 19th century. It has been unclear when does it show up as a relevant category.
...
- Important role in early modern knowledge production. It has not been analysed in what language they were in Finland (and Sweden). 
