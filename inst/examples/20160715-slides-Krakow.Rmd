...
Esitysjärjestys: Sivun 19 slide ("Development of use of different languages in Finnish NationalBibliography") pitäisi tulla sivun 21 sliden ("Different languages in Fennica and Kungliga (percentage)") jälkeen (samalla sivun 20 slide "Development of use of different languages in Kungliga data" putoaa pois). Mutta nyt kun muutan järjestystä niin sivun 21 slide ei sen jälkeen toimi. Tämä pitää fiksata.

Karttakuvassa Greifswald, Lund ei näy. Tätä pitää vähän miettiä.

Dissertation languages: kategoria "other" sisällön selvittäminen!

Joissain kuvista puuttuu vielä mystisesti ne akselitiedot. Lisäksi Mikko tsekkaa kuvien tekstit yms.

Gävle-kuvan kohtalo pitää tsiigata myös.
...
1) Big picture and political events

2) Publishers in Sweden and Turku

3) Languages and religious publishing in Finland
...
```{r publishingactivitycomparisons, echo=FALSE, message=FALSE, cache=TRUE, fig.width=6, fig.height=5, fig.show="hold", out.width="150px"}
v <- seq(1500, 1800, 50)
...
### Role of pamphleteering in 1766-1774

Pamphleteering clearly causes the peak in publishing during the time of abolished censorship in Sweden.
