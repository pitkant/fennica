...
Selitys puuttuville palloille: Kungligassa ei ole yhtään kaupunkia mainittuina vuosikymmeninä joille geokoordinaatit olisi tiedossa. Eli dataa ei ole. Ei siis palloja. MT: Voisiko tätä kuvaa muuttaa niin että tarkkaillaan vaan samoja yliopistokaupunkeja joita muutenkin otsikolla "Publishing activity in Swedish University Towns (based on Kungliga data)", eli haetaan koordinaatit näille mitä me pääasiassa tarkkaillaan: "Stockholm", "Uppsala", "Lund", "Greifswald", "Turku", "Tartu"? Sitten datana käyttäisi Kungligaa.
...
TODO: Todella tärkeä slide. Kehitysidea: voisiko nämä yhdistää yhteen ainoaan kaavioon niin että siinä olisi mukana valittuna pelkästään Fennicasta "Turku" ja "Vyborg" sekä Kungligasta "Stockholm", "Lund", "Uppsala", "Greifswald" ja "Tartu"? Näin ollen näkisi selvästi sitten erot ja kehityksen kun n on sama.
...
TODO: Rajataan analyysi Turku (Fennican pohjalta), Stockholm (Kungligan pohjalta), Lund (Kungligan pohjalta) ja Uppsala (Kungligan pohjalta)
