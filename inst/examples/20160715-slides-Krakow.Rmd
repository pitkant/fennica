...
```{r comparisons, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, eval = FALSE, fig.width=20, fig.height=15}
pics <- list()
...
TODO: asiasanoja / yliopistopaikkakunta vertailu Kungligasta. Ts. mitä enemmän eri aikoina asiasanoja (ihan sama mitä ne on) paikkakunnalla, sitä monimuotoisempaa/rikkaampaa julkaisutoiminta?
