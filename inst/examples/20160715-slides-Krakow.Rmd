...
TODO MT: Voisiko tätä kuvaa muuttaa niin että tarkkaillaan vain samoja yliopistokaupunkeja joita muutenkin otsikolla "Publishing activity in Swedish University Towns (based on Kungliga data)", eli haetaan koordinaatit näille: "Stockholm", "Uppsala", "Lund", "Greifswald", "Turku", "Tartu"? Sitten datana käyttäisi Kungligaa.
