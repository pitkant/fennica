...
```{r linkoping, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=10}
minyear <- 1640
maxyear <- 1828
myplace <- "Linköping"
cat <- "Kungliga"
...
dfs <- df %>% select(publication_decade, publisher) %>% unique
p <- plot_timeline(dfs, x = "publication_decade") +
