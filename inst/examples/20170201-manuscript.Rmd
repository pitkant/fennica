...
city.colors <- stata_pal("s2color")(length(city.colors))
...
```{r Fig3prep, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=18, fig.height=5, fig.show="hide", results="hide"}
library(scales)
...
```{r Fig3, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=18, fig.height=5}
...
```{r Fig4, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=5, fig.width=15, fig.show="last"}
cols <- list(Fennica = "blue", Kungliga = "darkred")
