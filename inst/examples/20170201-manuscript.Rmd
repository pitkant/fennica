...
#knitr::opts_chunk$set(dev = "cairo_postscript") # Embed fonts
# knitr::opts_chunk$set(dev = c("png", "svg")) # Embed fonts
...
```{r Figure_1, message=FALSE, warning=FALSE, fig.width=10, fig.height=4, echo=FALSE}

#message=FALSE, warning=FALSE, fig.width=10, fig.height=4, echo=FALSE, dpi=300, dev="postscript", out.format="latex", out.width="30%"
