...
```{r places_per_decade, message=FALSE, warning=FALSE, fig.width=10, fig.height=3, echo=FALSE}
library(dplyr)
library(ggplot2)
...
p <- ggplot(df, aes(x = publication_decade, y = n, color = catalog)) + 
       geom_point() + 
       geom_line() + 
       ylab("Publication places (n)") + xlab("Publication year") +
       scale_color_manual(values = c("blue", "darkgreen")) + 
       guides(color = guide_legend(reverse = TRUE, title = "")) +
       ggtitle("Number of unique publication places")
print(p)
```
...
```{r LIBER-13, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=11, fig.height=9, fig.show="hold"}
...
```{r riksdar_kungliga, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
...
```{r riksdar_fennica, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
minyear <- 1760
maxyear <- 1860
catal <- "Fennica"
