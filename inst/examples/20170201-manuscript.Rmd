...
```{r Fig9, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=5, fig.width=10}
library(dplyr)
catalogue <- "Fennica"
place <- "Vaasa"
minyear <- 1750
...
```{r Fig10, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=5, fig.width=12}
library(dplyr)
place <- "Turku"
catalogue = "Fennica"
df = df0
...
```{r Fig11, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
...
```{r Fig15, echo=FALSE, message=FALSE, warning=FALSE, fig.width=15, fig.height=7}
pics <- list()
theme_set(theme_bw(20))
...
```{r Fig16, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=5, fig.show="hold"}
catalogue <- "Fennica"
...
```{r Fig17, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
...
```{r Fig18, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=5, fig.show="hold"}
