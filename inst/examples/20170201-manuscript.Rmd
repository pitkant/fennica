...
```{r Fig4, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=14, fig.width=7}
...
```{r Fig7, echo=FALSE, message=FALSE, warning=FALSE, fig.width=15, fig.height=5}
