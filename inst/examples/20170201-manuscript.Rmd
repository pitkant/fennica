...
```{r LIBER-13, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=11, fig.height=9, fig.show="hold", out.width="350px"}
...
p <- ggplot(df, aes(x = publication_decade, y = paper)) +
       ...
       guides(shape = guide_legend(shape = "Place"))
print(p)
```
