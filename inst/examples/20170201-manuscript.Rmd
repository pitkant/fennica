...
```{r Fig3, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=9, fig.height=5, fig.show="hold", out.width="400px"}
...
```{r Fig4, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=7, fig.width=15}
# Analysis time window
df <- df0 %>% filter(publication_year >= 1640 & publication_year <= 1911) %>%
              group_by(publication_decade) %>%
              summarize(mean_title_length = mean(title_length_wordcount),
	      		n = n())

for (catal in unique(df$catalog)) {
  dfs <- subset(df, catalog == catal)
  p <- ggplot(dfs, aes(x = publication_decade, y = mean_title_length)) +
       geom_point(aes(size = n), size = 5) +
       geom_line(size = 1) +
       ylab("Title length (word count)") +
       xlab("Publication decade") +
       ggtitle(paste("Title length (", catal, ")", sep = ""))
...
```{r Fig5, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=18, fig.height=10}
pics <- list()
...
```{r Fig6, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=4}
library(magrittr)
library(ggplot2)
library(dplyr)
v <- seq(1500, 1800, 100)
...
```{r Fig7A, echo=FALSE, message=FALSE, warning=FALSE, fig.width=15, fig.height=5}
...
```{r Fig7B, echo=FALSE, message=FALSE, warning=FALSE, fig.width=15, fig.height=5}
minyear <- 1760
maxyear <- 1860
catal <- "Fennica"
...
```{r Fig8, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=7, fig.width=15}
df <- df0
catal <- "Fennica"
df <- df %>%
...
```{r Fig9, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=7, fig.width=15}
df <- df0
catal <- "Kungliga"
df <- df %>%
        filter(catalog == catal) %>%
...
```{r Fig10, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=6, fig.width=12}
library(dplyr)
catalogue <- "Fennica"
place <- "Vaasa"
minyear <- 1750
...
```{r Fig11, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=6, fig.width=12}
library(dplyr)
place <- "Turku"
catalogue = "Fennica"
df = df0
...
```{r Fig16, echo=FALSE, message=FALSE, warning=FALSE, fig.width=20, fig.height=12}
pics <- list()
theme_set(theme_bw(20))
...
```{r Fig17, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=6, fig.show="hold"}
catalogue <- "Fennica"
...
```{r Fig18, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=6}
