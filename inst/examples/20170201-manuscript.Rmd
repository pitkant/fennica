...
```{r Fig4, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=7, fig.width=16}
...
```{r Fig5, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=16, fig.height=8}
pics <- list()
...
```{r Fig16, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=7}
pics <- list()
theme_set(theme_bw(20))
