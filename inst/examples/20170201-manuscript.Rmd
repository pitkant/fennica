...
```{r Fig4, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=5, fig.width=11}
...
```{r Fig5, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=14, fig.height=6}
pics <- list()
...
```{r Fig7, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=4}
