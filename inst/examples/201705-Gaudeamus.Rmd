...
input.data.file <- "df.combined.20170125.Rds"
...
```{r Gaudeamus-3, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=11, fig.height=13, dev="CairoJPEG"}
...
```{r Gaudeamus-Vaasa, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=11, fig.height=6, dev="CairoJPEG"}
library(dplyr)
theme_set(theme_bw(22))
...
```{r Gaudeamus-Turku, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=11, fig.height=6, dev="CairoJPEG"}
library(dplyr)
theme_set(theme_bw(22))
df2 <- df.combined.preprocessed %>% filter(!is.na(publication_decade)) %>% 
       	       filter(catalog == "Fennica") %>%
...
```{r Gaudeamus-Helsinki, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=11, fig.height=6, dev="CairoJPEG"}
library(dplyr)
theme_set(theme_bw(22))
df2 <- df.combined.preprocessed %>% filter(!is.na(publication_decade)) %>% 
       	       filter(catalog == "Fennica") %>%
...
```{r Gaudeamus-Suomi, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=11, fig.height=6, dev="CairoJPEG"}
library(dplyr)
theme_set(theme_bw(22))
df2 <- df.combined.preprocessed %>% filter(!is.na(publication_decade)) %>% 
       	       filter(catalog == "Fennica") %>%
...
```{r Gaudeamus-Suomi2, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=11, fig.height=6, dev="CairoJPEG"}
library(dplyr)
theme_set(theme_bw(22))
