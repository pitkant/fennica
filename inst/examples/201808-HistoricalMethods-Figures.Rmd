...
npub$publication_place <- factor(npub$publication_place, levels = rev(c("Other", setdiff(npub$publication_place, "Other"))))
...
for (Catalogue in c("FNB", "SNB")) {
  ...
  brs <- seq(min(df.full$publication_decade), max(df.full$publication_decade), 10)  
