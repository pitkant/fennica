...
tmp1 <- df %>% filter(publication_place == "Vaasa") %>% group_by(published_in) %>% tally() %>% arrange(published_in)
...
par(mgp=c(10,3,0))
par(mar=c(7,17,6,4))
plot(final$published_in,final$n,cex=1.8,pch="|",cex.main=5.0,main="Julkaisutoiminta Vaasassa 1764-1917",cex.lab=5.0,xlab="",ylab="Dokumenttia / vuosi",axes=FALSE,col="black")
