...
```
## Error in axis(side = 1, at = c(1764, 1809, 1863, 1917), cex.axis = 3.2): plot.new has not been called yet
```

```
## Error in axis(side = 2, at = c(0, 40, 80, 120, 160, 194), cex.axis = 3.2): plot.new has not been called yet
```
