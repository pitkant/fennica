...
unique_cities <- collect_misspellings("amsterdam",c("Amsterdam"),unique_cities)
...
unique_cities <- collect_misspellings("barcelona",c("Barcelona"),unique_cities)
...
unique_cities <- collect_misspellings("brooklyn",c("Brooklyn","Brooklyn NY","Brooklyn New York","Brooklynissa NY"),unique_cities)
...
unique_cities <- collect_misspellings("kaleva",c("Kaleva","Kaleva MI","Kaleva Mich","Kaleva Michigan","Kalevassa Mich"),unique_cities)
...
unique_cities <- collect_misspellings("tukholma",c("Tukholma","Tukholmassa","Stockholm","Stockholmiae"),unique_cities)
...
unique_cities <- collect_misspellings("viipuri",c("Viipuri","Viipurissa","Viborg","Wiburgiae"),unique_cities) # huom! Tanskassakin on Viborg
unique_cities <- collect_misspellings("vilna",c("Vilna"),unique_cities)
...
df$city <- correct_misspellings(df$city,"vilna","Vilna")
