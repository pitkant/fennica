...
unique_cities <- unique(df$publication@place)
...
df$publication@place <- correct_misspellings(df$publication@place,"almena","Almena WI")
df$publication@place <- correct_misspellings(df$publication@place,"altdorf","Altdorf")
df$publication@place <- correct_misspellings(df$publication@place,"ashtabula","Ashtabula OH")
df$publication@place <- correct_misspellings(df$publication@place,"astoria","Astoria OR")
df$publication@place <- correct_misspellings(df$publication@place,"berliini","Berliini")
df$publication@place <- correct_misspellings(df$publication@place,"boston","Boston MA")
df$publication@place <- correct_misspellings(df$publication@place,"bridgeport","Bridgeport CT")
df$publication@place <- correct_misspellings(df$publication@place,"bronx","Bronx NY")
df$publication@place <- correct_misspellings(df$publication@place,"brooklyn","Brooklyn NY")
df$publication@place <- correct_misspellings(df$publication@place,"calumet","Calumet MI")
df$publication@place <- correct_misspellings(df$publication@place,"chicago","Chicago IL")
df$publication@place <- correct_misspellings(df$publication@place,"chisholm","Chisholm MN")
df$publication@place <- correct_misspellings(df$publication@place,"cincinnati","Cincinnati OH")
df$publication@place <- correct_misspellings(df$publication@place,"cleveland","Cleveland OH")
df$publication@place <- correct_misspellings(df$publication@place,"duluth","Duluth MN")
df$publication@place <- correct_misspellings(df$publication@place,"espoo","Espoo")
df$publication@place <- correct_misspellings(df$publication@place,"fitchburg","Fitchburg MA")
df$publication@place <- correct_misspellings(df$publication@place,"giessen","Giessen")
df$publication@place <- correct_misspellings(df$publication@place,"goteborg","Göteborg")
df$publication@place <- correct_misspellings(df$publication@place,"gottingen","Göttingen")
df$publication@place <- correct_misspellings(df$publication@place,"greifswald","Greifswald")
df$publication@place <- correct_misspellings(df$publication@place,"haaparanta","Haaparanta")
df$publication@place <- correct_misspellings(df$publication@place,"hamina","Hamina")
df$publication@place <- correct_misspellings(df$publication@place,"hampuri","Hampuri")
df$publication@place <- correct_misspellings(df$publication@place,"hancock","Hancock MI")
df$publication@place <- correct_misspellings(df$publication@place,"hanko","Hanko")
df$publication@place <- correct_misspellings(df$publication@place,"helsinki","Helsinki")
df$publication@place <- correct_misspellings(df$publication@place,"hameenlinna","Hämeenlinna")
df$publication@place <- correct_misspellings(df$publication@place,"ironwood","Ironwood MI")
df$publication@place <- correct_misspellings(df$publication@place,"ishpeming","Ishpeming MI")
df$publication@place <- correct_misspellings(df$publication@place,"jena","Jena")
df$publication@place <- correct_misspellings(df$publication@place,"jyvaskyla","Jyväskylä")
df$publication@place <- correct_misspellings(df$publication@place,"kaleva","Kaleva MI")
df$publication@place <- correct_misspellings(df$publication@place,"kaliningrad","Kaliningrad")
df$publication@place <- correct_misspellings(df$publication@place,"karjaa","Karjaa")
df$publication@place <- correct_misspellings(df$publication@place,"kaskinen","Kaskinen")
df$publication@place <- correct_misspellings(df$publication@place,"kiel","Kiel")
df$publication@place <- correct_misspellings(df$publication@place,"kokkola","Kokkola")
df$publication@place <- correct_misspellings(df$publication@place,"kotka","Kotka")
df$publication@place <- correct_misspellings(df$publication@place,"kouvola","Kouvola")
df$publication@place <- correct_misspellings(df$publication@place,"kristiinankaupunki","Kristiinankaupunki")
df$publication@place <- correct_misspellings(df$publication@place,"kruunupyy","Kruunupyy")
df$publication@place <- correct_misspellings(df$publication@place,"kuopio","Kuopio")
df$publication@place <- correct_misspellings(df$publication@place,"koln","Köln")
df$publication@place <- correct_misspellings(df$publication@place,"koopenhamina","Kööpenhamina")
df$publication@place <- correct_misspellings(df$publication@place,"lahti","Lahti")
df$publication@place <- correct_misspellings(df$publication@place,"lappeenranta","Lappeenranta")
df$publication@place <- correct_misspellings(df$publication@place,"leiden","Leiden")
df$publication@place <- correct_misspellings(df$publication@place,"linkoping","Linköping")
df$publication@place <- correct_misspellings(df$publication@place,"lontoo","Lontoo")
df$publication@place <- correct_misspellings(df$publication@place,"loviisa","Loviisa")
df$publication@place <- correct_misspellings(df$publication@place,"lund","Lund")
df$publication@place <- correct_misspellings(df$publication@place,"lyypekki","Lyypekki")
df$publication@place <- correct_misspellings(df$publication@place,"maarianhamina","Maarianhamina")
df$publication@place <- correct_misspellings(df$publication@place,"magdeburg","Magdeburg")
df$publication@place <- correct_misspellings(df$publication@place,"marburg","Marburg")
df$publication@place <- correct_misspellings(df$publication@place,"mikkeli","Mikkeli")
df$publication@place <- correct_misspellings(df$publication@place,"milwaukee","Milwaukee WI")
df$publication@place <- correct_misspellings(df$publication@place,"minneapolis","Minneapolis MN")
df$publication@place <- correct_misspellings(df$publication@place,"moskova","Moskova")
df$publication@place <- correct_misspellings(df$publication@place,"nanaimo","Nanaimo BC")
df$publication@place <- correct_misspellings(df$publication@place,"narva","Narva")
df$publication@place <- correct_misspellings(df$publication@place,"newyork","New York NY")
df$publication@place <- correct_misspellings(df$publication@place,"newyorkmills","New York Mills MN")
df$publication@place <- correct_misspellings(df$publication@place,"oslo","Oslo")
df$publication@place <- correct_misspellings(df$publication@place,"oulu","Oulu")
df$publication@place <- correct_misspellings(df$publication@place,"pariisi","Pariisi")
df$publication@place <- correct_misspellings(df$publication@place,"philadelphia","Philadelphia PA")
df$publication@place <- correct_misspellings(df$publication@place,"pietari","Pietari")
df$publication@place <- correct_misspellings(df$publication@place,"pietarsaari","Pietarsaari")
df$publication@place <- correct_misspellings(df$publication@place,"pori","Pori")
df$publication@place <- correct_misspellings(df$publication@place,"portarthur","Port Arthur ON")
df$publication@place <- correct_misspellings(df$publication@place,"portland","Portland OR")
df$publication@place <- correct_misspellings(df$publication@place,"porvoo","Porvoo")
df$publication@place <- correct_misspellings(df$publication@place,"parnu","Pärnu")
df$publication@place <- correct_misspellings(df$publication@place,"quincy","Quincy MA")
df$publication@place <- correct_misspellings(df$publication@place,"rauma","Rauma")
df$publication@place <- correct_misspellings(df$publication@place,"riika","Riika")
df$publication@place <- correct_misspellings(df$publication@place,"rockisland","Rock Island IL")
df$publication@place <- correct_misspellings(df$publication@place,"rooma","Rooma")
df$publication@place <- correct_misspellings(df$publication@place,"rostock","Rostock")
df$publication@place <- correct_misspellings(df$publication@place,"seattle","Seattle WA")
df$publication@place <- correct_misspellings(df$publication@place,"sipoo","Sipoo")
df$publication@place <- correct_misspellings(df$publication@place,"smithville","Smithville MN")
df$publication@place <- correct_misspellings(df$publication@place,"sortavala","Sortavala")
df$publication@place <- correct_misspellings(df$publication@place,"strangnas","Strängnäs")
df$publication@place <- correct_misspellings(df$publication@place,"superior","Superior WI")
df$publication@place <- correct_misspellings(df$publication@place,"tallinna","Tallinna")
df$publication@place <- correct_misspellings(df$publication@place,"tammisaari","Tammisaari")
df$publication@place <- correct_misspellings(df$publication@place,"tampere","Tampere")
df$publication@place <- correct_misspellings(df$publication@place,"tartto","Tartto")
df$publication@place <- correct_misspellings(df$publication@place,"tukholma","Tukholma")
df$publication@place <- correct_misspellings(df$publication@place,"turenki","Turenki")
df$publication@place <- correct_misspellings(df$publication@place,"turku","Turku")
df$publication@place <- correct_misspellings(df$publication@place,"uppsala","Uppsala")
df$publication@place <- correct_misspellings(df$publication@place,"uusikaarlepyy","Uusikaarlepyy")
df$publication@place <- correct_misspellings(df$publication@place,"uusikaupunki","Uusikaupunki")
df$publication@place <- correct_misspellings(df$publication@place,"vaasa","Vaasa")
df$publication@place <- correct_misspellings(df$publication@place,"viipuri","Viipuri")
df$publication@place <- correct_misspellings(df$publication@place,"vasteros","Västerås")
df$publication@place <- correct_misspellings(df$publication@place,"wittenberg","Wittenberg")
df$publication@place <- correct_misspellings(df$publication@place,"worcester","Worcester MA")
