...
unique_cities <- fixEncoding(unique(df$publication_place),latin1=TRUE)
...
for(x in basecase){
	df$publication_place <- correct_misspellings(df$publication_place,x)
}

df$publication_place <- correct_misspellings(df$publication_place,"Almena WI")
df$publication_place <- correct_misspellings(df$publication_place,"Altdorf")
df$publication_place <- correct_misspellings(df$publication_place,"Amsterdam")
df$publication_place <- correct_misspellings(df$publication_place,"Ashtabula OH")
df$publication_place <- correct_misspellings(df$publication_place,"Astoria OR")
df$publication_place <- correct_misspellings(df$publication_place,"Barcelona")
df$publication_place <- correct_misspellings(df$publication_place,"Berliini")
df$publication_place <- correct_misspellings(df$publication_place,"Boston MA")
df$publication_place <- correct_misspellings(df$publication_place,"Bridgeport CT")
df$publication_place <- correct_misspellings(df$publication_place,"Bronx NY")
df$publication_place <- correct_misspellings(df$publication_place,"Brooklyn NY")
df$publication_place <- correct_misspellings(df$publication_place,"Calumet MI")
df$publication_place <- correct_misspellings(df$publication_place,"Chicago IL")
df$publication_place <- correct_misspellings(df$publication_place,"Chisholm MN")
df$publication_place <- correct_misspellings(df$publication_place,"Cincinnati OH")
df$publication_place <- correct_misspellings(df$publication_place,"Cleveland OH")
df$publication_place <- correct_misspellings(df$publication_place,"Duluth MN")
df$publication_place <- correct_misspellings(df$publication_place,"Espoo")
df$publication_place <- correct_misspellings(df$publication_place,"Fitchburg MA")
df$publication_place <- correct_misspellings(df$publication_place,"Giessen")
df$publication_place <- correct_misspellings(df$publication_place,"Göteborg")
df$publication_place <- correct_misspellings(df$publication_place,"Göttingen")
df$publication_place <- correct_misspellings(df$publication_place,"Greifswald")
df$publication_place <- correct_misspellings(df$publication_place,"Haaparanta")
df$publication_place <- correct_misspellings(df$publication_place,"Hamina")
df$publication_place <- correct_misspellings(df$publication_place,"Hampuri")
df$publication_place <- correct_misspellings(df$publication_place,"Hancock MI")
df$publication_place <- correct_misspellings(df$publication_place,"Hanko")
df$publication_place <- correct_misspellings(df$publication_place,"Helsinki")
df$publication_place <- correct_misspellings(df$publication_place,"Hämeenlinna")
df$publication_place <- correct_misspellings(df$publication_place,"Ironwood MI")
df$publication_place <- correct_misspellings(df$publication_place,"Ishpeming MI")
df$publication_place <- correct_misspellings(df$publication_place,"Jena")
df$publication_place <- correct_misspellings(df$publication_place,"Jyväskylä")
df$publication_place <- correct_misspellings(df$publication_place,"Kaleva MI")
df$publication_place <- correct_misspellings(df$publication_place,"Kaliningrad")
df$publication_place <- correct_misspellings(df$publication_place,"Karjaa")
df$publication_place <- correct_misspellings(df$publication_place,"Karlskrona")
df$publication_place <- correct_misspellings(df$publication_place,"Kaskinen")
df$publication_place <- correct_misspellings(df$publication_place,"Kiel")
df$publication_place <- correct_misspellings(df$publication_place,"Kokkola")
df$publication_place <- correct_misspellings(df$publication_place,"Kotka")
df$publication_place <- correct_misspellings(df$publication_place,"Kouvola")
df$publication_place <- correct_misspellings(df$publication_place,"Kristiinankaupunki")
df$publication_place <- correct_misspellings(df$publication_place,"Kruunupyy")
df$publication_place <- correct_misspellings(df$publication_place,"Kuopio")
df$publication_place <- correct_misspellings(df$publication_place,"Köln")
df$publication_place <- correct_misspellings(df$publication_place,"Kööpenhamina")
df$publication_place <- correct_misspellings(df$publication_place,"Lahti")
df$publication_place <- correct_misspellings(df$publication_place,"Lappeenranta")
df$publication_place <- correct_misspellings(df$publication_place,"Leiden")
df$publication_place <- correct_misspellings(df$publication_place,"Linköping")
df$publication_place <- correct_misspellings(df$publication_place,"Lontoo")
df$publication_place <- correct_misspellings(df$publication_place,"Loviisa")
df$publication_place <- correct_misspellings(df$publication_place,"Lund")
df$publication_place <- correct_misspellings(df$publication_place,"Lyypekki")
df$publication_place <- correct_misspellings(df$publication_place,"Maarianhamina")
df$publication_place <- correct_misspellings(df$publication_place,"Magdeburg")
df$publication_place <- correct_misspellings(df$publication_place,"Marburg")
df$publication_place <- correct_misspellings(df$publication_place,"Mikkeli")
df$publication_place <- correct_misspellings(df$publication_place,"Milwaukee WI")
df$publication_place <- correct_misspellings(df$publication_place,"Minneapolis MN")
df$publication_place <- correct_misspellings(df$publication_place,"Moskova")
df$publication_place <- correct_misspellings(df$publication_place,"Nanaimo BC")
df$publication_place <- correct_misspellings(df$publication_place,"Narva")
df$publication_place <- correct_misspellings(df$publication_place,"New York NY")
df$publication_place <- correct_misspellings(df$publication_place,"New York Mills MN")
df$publication_place <- correct_misspellings(df$publication_place,"Oslo")
df$publication_place <- correct_misspellings(df$publication_place,"Oulu")
df$publication_place <- correct_misspellings(df$publication_place,"Pariisi")
df$publication_place <- correct_misspellings(df$publication_place,"Philadelphia PA")
df$publication_place <- correct_misspellings(df$publication_place,"Pietari")
df$publication_place <- correct_misspellings(df$publication_place,"Pietarsaari")
df$publication_place <- correct_misspellings(df$publication_place,"Pori")
df$publication_place <- correct_misspellings(df$publication_place,"Port Arthur ON")
df$publication_place <- correct_misspellings(df$publication_place,"Portland OR")
df$publication_place <- correct_misspellings(df$publication_place,"Porvoo")
df$publication_place <- correct_misspellings(df$publication_place,"Pärnu")
df$publication_place <- correct_misspellings(df$publication_place,"Quincy MA")
df$publication_place <- correct_misspellings(df$publication_place,"Rauma")
df$publication_place <- correct_misspellings(df$publication_place,"Riika")
df$publication_place <- correct_misspellings(df$publication_place,"Rock Island IL")
df$publication_place <- correct_misspellings(df$publication_place,"Rooma")
df$publication_place <- correct_misspellings(df$publication_place,"Rostock")
df$publication_place <- correct_misspellings(df$publication_place,"Seattle WA")
df$publication_place <- correct_misspellings(df$publication_place,"Sipoo")
df$publication_place <- correct_misspellings(df$publication_place,"Smithville MN")
df$publication_place <- correct_misspellings(df$publication_place,"Sortavala")
df$publication_place <- correct_misspellings(df$publication_place,"Strängnäs")
df$publication_place <- correct_misspellings(df$publication_place,"Superior WI")
df$publication_place <- correct_misspellings(df$publication_place,"Tallinna")
df$publication_place <- correct_misspellings(df$publication_place,"Tammisaari")
df$publication_place <- correct_misspellings(df$publication_place,"Tampere")
df$publication_place <- correct_misspellings(df$publication_place,"Tartto")
df$publication_place <- correct_misspellings(df$publication_place,"Tukholma")
df$publication_place <- correct_misspellings(df$publication_place,"Turenki")
df$publication_place <- correct_misspellings(df$publication_place,"Turku")
df$publication_place <- correct_misspellings(df$publication_place,"Uppsala")
df$publication_place <- correct_misspellings(df$publication_place,"Uusikaarlepyy")
df$publication_place <- correct_misspellings(df$publication_place,"Uusikaupunki")
df$publication_place <- correct_misspellings(df$publication_place,"Vaasa")
df$publication_place <- correct_misspellings(df$publication_place,"Varsova")
df$publication_place <- correct_misspellings(df$publication_place,"Viipuri")
df$publication_place <- correct_misspellings(df$publication_place,"Vilna")
df$publication_place <- correct_misspellings(df$publication_place,"Västerås")
df$publication_place <- correct_misspellings(df$publication_place,"Wittenberg")
df$publication_place <- correct_misspellings(df$publication_place,"Worcester MA")
