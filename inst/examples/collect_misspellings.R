...
mikkeli <- collect_misspellings(df$pub_where,c("Mikkeli","St Mikkeli","St Michel"))
...
pietari <- collect_misspellings(df$pub_where,c("Pietari","St Petersburg","Petrograd"))
...
sortavala <- collect_misspellings(df$pub_where,c("Sortavala"))
...
tukholma <- collect_misspellings(df$pub_where,c("Tukholma","Stockholm"))
...
vaasa <- collect_misspellings(df$pub_where,c("Vaasa","Nikolainkaupunki","Nikolaistad"))
viipuri <- collect_misspellings(df$pub_where,c("Viipuri","Viborg")) # huom! Tanskassakin on Viborg
...
helsinki <- c(helsinki,"Helsingforsiae","Hki","Helsingissä; Helsinki","Hfors","Helsingforsisa","Helsinki sn","Helsingfors; Helsingfors","Helsingfors sn","Helsingfors Helsingi")
