correct_misspellings <- function(v) {
	v[v %in% almena] <- "Almena WI"
	v[v %in% altdorf] <- "Altdorf"
	v[v %in% ashtabula] <- "Ashtabula OH"
	v[v %in% astoria] <- "Astoria OR"
	v[v %in% berliini] <- "Berliini"
	v[v %in% boston] <- "Boston MA"
	v[v %in% bridgeport] <- "Bridgeport CT"
	v[v %in% bronx] <- "Bronx NY"
	v[v %in% brooklyn] <- "Brooklyn"
	v[v %in% calumet] <- "Calumet MI"
	v[v %in% chicago] <- "Chicago IL"
	v[v %in% chisholm] <- "Chisholm MN"
	v[v %in% cincinnati] <- "Cincinnati OH"
	v[v %in% cleveland] <- "Cleveland OH"
	...
	v[v %in% ironwood] <- "Ironwood MI"
	v[v %in% ishpeming] <- "Ishpeming MI"
	v[v %in% jena] <- "Jena"
	...
	v[v %in% milwaukee] <- "Milwaukee WI"
	v[v %in% minneapolis] <- "Minneapolis MN"
	v[v %in% moskova] <- "Moskova"
	v[v %in% nanaimo] <- "Nanaimo BC"
	v[v %in% narva] <- "Narva"
	v[v %in% newyork] <- "New York NY"
	v[v %in% oslo] <- "Oslo"
	v[v %in% oulu] <- "Oulu"
	v[v %in% pariisi] <- "Pariisi"
	v[v %in% philadelphia] <- "Philadelphia PA"
	v[v %in% pietari] <- "Pietari"
	v[v %in% pietarsaari] <- "Pietarsaari"
	v[v %in% pori] <- "Pori"
	v[v %in% portarthur] <- "Port Arthur ON"
	v[v %in% portland] <- "Portland OR"
	v[v %in% porvoo] <- "Porvoo"
	v[v %in% parnu] <- "Pärnu"
	v[v %in% quincy] <- "Quincy MA"
	v[v %in% riika] <- "Riika"
	v[v %in% rockisland] <- "Rock Island IL"
	v[v %in% rooma] <- "Rooma"
	v[v %in% rostock] <- "Rostock"
	v[v %in% seattle] <- "Seattle WA"
	v[v %in% sipoo] <- "Sipoo"
	v[v %in% smithville] <- "Smithville MN"
	v[v %in% sortavala] <- "Sortavala"
	v[v %in% strangnas] <- "Strängnäs"
	v[v %in% superior] <- "Superior WI"
