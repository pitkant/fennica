...
* [Unique accepted titles](output.tables/title_accepted.csv): `r length(unique(df$holder))`
* [Unique discarded titles in original data](output.tables/title_discarded.csv) (excluding NA cases): `r as.vector(countLines(paste0(output.folder, "/holder_discarded.csv")) - 1)` 
