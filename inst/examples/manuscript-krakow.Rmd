...
The raw data contains metadata `r nrow(fenraw)` and `r nrow(kunraw)` documents in Fennica and Kungliga, respectively. After initial preprocessing and limiting the analysis between the years `r min(df0$publication_year)`-`r max(df0$publication_year)`, we had `r nrow(subset(df0, catalog == "Fennica"))` and `r nrow(subset(df0, catalog == "Kungliga"))` documents for Fennica and Kungliga, respectively.
