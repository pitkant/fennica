...
for (catal in unique(df0$catalog)) {
  ...
  res <- plot_timeline(dfs, field = "titlecount", group = "gatherings", nmin = 15, mode = "absolute") 
  print(res + ggtitle(paste(catal, " (n)", sep = "")))
 
  res <- plot_timeline(dfs, field = "titlecount", group = "gatherings", nmin = 15, mode = "relative") 
