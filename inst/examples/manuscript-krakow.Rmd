...
```{r language1, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px", fig.show="hold"}
# TITLE COUNT
for (catalogue in c("Fennica", "Kungliga")) {
...
```{r language-perc, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px", fig.show="hold"}
# TITLE COUNT
for (catalogue in c("Fennica", "Kungliga")) {
...
```{r language-sel, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px", fig.show="hold"}
# TITLE COUNT
for (catalogue in c("Fennica", "Kungliga")) {
