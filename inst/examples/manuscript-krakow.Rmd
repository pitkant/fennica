...
Lisäsin alle seuraavat TODO:t: TODO_Political events 1, TODO_Turku in Sweden 1, TODO_Turku in Sweden 2, TODO_Publisher analysis_#, TODO_Publishing in Finland # ja TODO_Publishing in Finland_kieliolosuhteet_muualla 1. Ovatko nämä toteuttamiskelpoisia?
...
vii) psykologia;yhteiskuntafilosofia;valtiofilosofia;talous;raha;moraali;velvollisuudet;kasvatus

viii) luonnonhistoria;lääketiede;tartuntataudit;eläintiede;kasvitiede;kasvisto;eläimet;eläinsuojelu;eläimistö;eläintaudit;hevonen;maanviljely;maatalous;kalastus
...
for (catal in as.character(unique(df0$catalog))) {
  ...
  p <- ggplot(dfs, aes(x = publication_decade, y = paper.per.document)) +
       geom_popuint(aes(color = publication_place, shape = publication_place)) +
