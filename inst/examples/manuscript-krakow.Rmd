...
```{r drop1700B, echo=FALSE, message=FALSE, warning=FALSE, fig.width=9, fig.height=6, out.width="280px"}
catalogue <- "Fennica"
place <- "Turku"
...
```{r publisherpapertitle, echo=FALSE, message=FALSE, warning=FALSE, fig.width=9, fig.height=6, out.width="430px", fig.show="hold"}
...
```{r summaryTop10authorstimeline, fig.height=10, fig.width=20, echo=FALSE, fig.show="hold", out.width="430px"}
theme_set(theme_bw(20))
for (catalogue in c("Fennica", "Kungliga")) {
