...
```{r topics, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px", fig.show="hold"}
# TITLE COUNT
catalogue <- "Fennica"
  ...
  df <- df %>% filter(catalog == catalogue & subject_topic %in% sel)
...
2. Selected publication places


```{r topics.per.place, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px", fig.show="hold"}
...
catalogue <- "Fennica"
  ...
  df <- df %>% filter(catalog == catalogue & hit & publication_place == place)
...
```{r topics.per.publisher, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px", fig.show="hold"}
...
catalogue <- "Fennica"
  ...
  df <- df %>% filter(catalog == catalogue & publisher == publ)
