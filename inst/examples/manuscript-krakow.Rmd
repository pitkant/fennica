...
After initial preprocessing, we had `r nrow(subset(df0, catalog == "Fennica"))` and `r nrow(subset(df0, catalog == "Kungliga"))` documents in Fennica and Kungliga, respectively between the years `r min(df0$publication_year)`-`r max(df0$publication_year)`.
