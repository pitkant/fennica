...
TODO: yksittäiset kuvat eri kaupungeista julkaisumääristä auttaisivat paljon yleistä miettimistä ja nämä olisi varmaan helppo generoida. Eli onko mahdollista tehdä kuvat kaupungeittain (eli samalla tavalla kun on jo Gävle):


Kungliga:


Tartu, Skara, Växjö, Uppsala, Lund, Strängnäs, Linköping, Gothenburg, Västerås, Nyköping
