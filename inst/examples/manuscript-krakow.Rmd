...
Selvensin alle (Publisher analysis kohtaan): PUBLISHER-TODO1 ja
PUBLISHER-TODO2. Lisäksi löytyy muita ajatuksia.
...
```{r publisherpapertitle, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px", fig.show="hold"}
...
```{r summaryTop10authorstimeline, fig.height=6, fig.width=10, echo=FALSE, fig.show="hold", out.width="430px"}
theme_set(theme_bw(20))
for (catalogue in c("Fennica", "Kungliga")) {
...
I can provide percentages instead
...
```{r language1, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px"}
# TITLE COUNT
for (catalogue in c("Fennica", "Kungliga")) {
...
```{r language-perc, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px"}
# TITLE COUNT
for (catalogue in c("Fennica", "Kungliga")) {
...
```{r language-sel, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, out.width="430px"}
# TITLE COUNT
for (catalogue in c("Fennica", "Kungliga")) {
...
theme_set(theme_bw(20))
p <- ggplot(dfs, aes(x = publication_decade, y = paper)) +
       geom_point(size = 5) +
       geom_line() +       
       xlab("Publication year") +
       ylab("Paper consumption") +
...
**PUBLISHER-TODO2** (Done?) Analysis of the top publishers publishing
  profile (title count and paper consumption) over time.
