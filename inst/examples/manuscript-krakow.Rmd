...
Tämä lista kiireysjärjestyksessä. Ensimmäiset 4 listalla pitäisi olla kohtuu nopea toteuttaa, ovat täydentäviä kuvia siitä mitä jo toteutettu. KUNGLIGAPUB1&2 on kaksi vaiheinen ja vaatii vähän enemmän työtä, mutta tärkeä. AUTHOR-osio viivan alla toteutetaan nyt jos ehditään. Pikkuhiljaa aletaan miettiä myös mikä karttamuotoinen kuva tuoteutetaan ja aletaan sitten hioa tätä samalla kohti esitystä.

**Lisäksi seuraavat TODOt kesken:**
...
**NOTE** Tulee enemmän kuin 6 kaaviota.. pistin kaikki viivat erikseen
  kun pyydettiin erikseen. Huom: pystyakselin skaala vaihtelee
  kuvittain.
...
```
**ranska ja venäjä pitäisi nostaa omiksi ryhmikseen tähän prosenttianalyysiin!**
...
### BOOKINFINLAND-DONE4 **TODO:kielten viilaus, pätee myös BOOKINFINLAND-5. Nyt "other" kentästä pitäisi irrottaa relevantit eli ranska ja venäjä mukaan.**
...
```
**BOOKFORMATS-TODO: sama paikallisten erojen tarkasteluun. Toteutustapa: otetaan tarkasteluun Kungligasta yksittäiset kaupungit. Käytetään yliopistokaupunkeja: Turku, Tukholma, Lund, Greifswald, Uppsala, Tartu sekä mukaan myös Vyborg ja Helsinki.**
