...
Kirjan kehitys mediana (miten yli 50 sivuiset dokumentit yleistyvät
ajassa / voidaanko tässä nähdä jotain paikallisia eroja?)

Paper consumption in books (balls) versus pamphlets (triangles). Books are any documents with more than 50 pages. Pamphlets are anything less or equal than 50 pages. Fennica data
