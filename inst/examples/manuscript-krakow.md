...
```
    ...
    ##  [1] git2r_0.15.0          knitcitations_1.0.7   devtools_1.12.0      
    ##  [4] gisfin_0.9.26         R6_2.1.2              rgdal_1.1-10         
    ##  [7] sp_1.2-3              ggmap_2.6.1           rmarkdown_0.9.6.14   
    ## [10] sorvi_0.7.47          tibble_1.1            fennica_0.1.42       
    ## [13] stringr_1.0.0         microbiome_0.99.83    phyloseq_1.16.2      
    ## [16] knitr_1.13            gridExtra_2.2.1       reshape2_1.4.1       
    ## [19] magrittr_1.5          bibliographica_0.2.25 dplyr_0.5.0          
    ## [22] tidyr_0.5.1           ggplot2_2.1.0        
    ## 
    ...
    ##  [64] RColorBrewer_1.1-2    curl_0.9.7            yaml_2.1.13          
    ##  [67] memoise_1.0.0         geosphere_1.5-5       rpart_4.1-10         
    ##  [70] latticeExtra_0.6-28   stringi_1.1.1         maptree_1.4-7        
    ##  [73] RSQLite_1.0.0         highr_0.6             S4Vectors_0.10.1     
    ##  [76] foreach_1.4.3         permute_0.9-0         BiocGenerics_0.18.0  
    ##  [79] bibtex_0.4.0          boot_1.3-18           chron_2.3-47         
    ##  [82] bitops_1.0-6          RgoogleMaps_1.2.0.7   moments_0.14         
    ##  [85] matrixStats_0.50.2    evaluate_0.9          lattice_0.20-33      
    ##  [88] labeling_0.3          plyr_1.8.4            IRanges_2.6.1        
    ##  [91] Hmisc_3.17-4          DBI_0.4-1             withr_1.0.2          
    ##  [94] foreign_0.8-66        mgcv_1.8-12           RCurl_1.95-4.8       
    ##  [97] survival_2.39-5       nnet_7.3-12           jpeg_0.1-8           
