...
* [Unique accepted entries](output.tables/note_510c_accepted.csv): `r length(unique(df$note_510c))`
* [Unique discarded entries in original data](output.tables/note_510c_discarded.csv) (excluding NA cases): `r as.vector(countLines(paste0(output.folder, "/note_510c_discarded.csv")) - 1)` 
