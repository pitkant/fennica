...
# Preprocessing summary: Fennica

The data spanning years `r min(na.omit(df$publication_year))`-`r max(na.omit(df$publication_year))` has been included and contains `r nrow(df.preprocessed)` documents (additional filters may apply depending on the analysis, see the source code for details).
