...
df.orig$physical_extent <- df.raw[["300a"]]
df.orig$physical_details <- df.raw[["300b"]]
df.orig$physical_dimension <- df.raw[["300c"]]
df.orig$physical_accomppanied <- df.raw[["300e"]]
