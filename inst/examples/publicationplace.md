 ...
 * 231 unique places (54.4% of all unique places) are missing geocoordinates. See the [list of places missing geocoordinate information](output.tables/absentgeocoordinates.csv). Altogether 1.99% of the documents have missing geocoordinates.
