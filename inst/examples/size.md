...
## Document size comparisons
  ...
  * Some dimension info is provided in the original data but could not be interpreted for 4778 documents (ie. dimension info was estimated for 100% of the documents where this field was not empty).
