...
Left: Gatherings vs. overall pagecounts. Right: Visual summary of the estimated page counts per gatherings (shown only for the 1544 documents that have missing pagecount info in the original data):
