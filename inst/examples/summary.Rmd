...
dfs <- df %>% select(author, publication_place, country, publication_year, published_from, published_till, corporate, area, pagecount, gatherings, width, height, paper.consumption.km2, publisher, self_published)
