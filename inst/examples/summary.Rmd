...
df <- readRDS("data/unified/polished/df.Rds")
...
dfs <- df %>% select(author, publication_place, publication_country, publication_year, publication_year_from, publication_year_till, corporate, area, pagecount, gatherings, width, height, paper, publisher, self_published)
