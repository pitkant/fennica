...
#~/bin/R-4.0.0/bin/R CMD check fennica_0.0.1.tar.gz
~/bin/R-4.0.0/bin/R CMD check --as-cran fennica_0.2.2.tar.gz --no-tests
~/bin/R-4.0.0/bin/R CMD INSTALL fennica_0.2.2.tar.gz
#~/bin/R-4.0.0/bin/R CMD BATCH document.R
