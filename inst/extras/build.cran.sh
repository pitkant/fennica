...
#~/bin/R-4.0.3/bin/R CMD check fennica_0.2.6.tar.gz
~/bin/R-4.0.3/bin/R CMD check --as-cran fennica_0.2.6.tar.gz --no-tests
~/bin/R-4.0.3/bin/R CMD INSTALL fennica_0.2.6.tar.gz
#~/bin/R-4.0.3/bin/R CMD BATCH document.R
